...
for sync_name in syncUnits:
    ...
    for camera_name in camera_list:
        ...
        print(blink.get_camera_battery_voltage_info(camera_name))
        temp = blink.get_camera_arm_info(camera_name)
        print(temp)
        print(blink.set_camera_arm(camera_name, not temp))
        print(blink.get_camera_arm_info(camera_name))
        print(blink.set_camera_arm(camera_name, temp))
        print(blink.get_camera_arm_info(camera_name))
        print(blink.get_camera_type_info(camera_name))

        print(blink.get_camera_motion_enabled_info(camera_name))
        print(blink.get_camera_motion_detected_info(camera_name))
